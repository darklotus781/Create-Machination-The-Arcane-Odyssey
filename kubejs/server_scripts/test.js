...
EntityEvents.spawned(event => {
    ...
    if (entity.type === "minecraft:zombie" && (event_string === "enhancedcelestials:blood_moon" || event_string === "enhancedcelestials:super_blood_moon")) {
        // if (getRandomInt(2) == 0) {
            event.server.runCommandSilent(`execute in ${entity.level.dimension} positioned ${entity.x} ${entity.y} ${entity.z} run summon minecraft:pillager`);
            //
            // event.cancel()
        // }
    }
