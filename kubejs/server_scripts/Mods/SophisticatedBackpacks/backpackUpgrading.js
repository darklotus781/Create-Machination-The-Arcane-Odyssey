...
BlockEvents.rightClicked(event => {
    ...
    else if (item == Item.of("cm-tao:leather_pocket").id && bpTag.pocket < 2) {slots = 6; data.backpackData.tag.pocket++}
...
ServerEvents.recipes(event => {
    event.smithing("cm-tao:leather_pocket", "minecraft:bundle", "minecraft:iron_ingot")
