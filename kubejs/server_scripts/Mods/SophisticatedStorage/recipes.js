...
ServerEvents.recipes(event => {
    ...
    event.shaped(Item.of('sophisticatedstorage:shulker_box'), [' S ', 'MCM', ' S '], { S: Item.of('minecraft:shulker_shell'), C: Ingredient.of('#sophisticatedstorage:chests'), M: Item.of('kubejs:logistics_mechanism') }).id('kubejs:ss_shulker_box');

    let makeBarrel = (wood) => {
        event.shaped(Item.of('sophisticatedstorage:barrel', '{woodType:"' + wood + '"}'), ['LPL', 'LML', 'LPL'], { L: Item.of('minecraft:' + wood + '_log'), P: Item.of('minecraft:' + wood + '_planks'), M: Item.of('kubejs:logistics_mechanism') }).id('kubejs:ss_' + wood + '_barrel');
    }

    let makeChest = (wood) => {
        event.shaped(Item.of('sophisticatedstorage:chest', '{woodType:"' + wood + '"}'), ['LLL', 'LML', 'LLL'], { L: Item.of('minecraft:' + wood + '_log'), M: Item.of('kubejs:logistics_mechanism') }).id('kubejs:ss_' + wood + '_chest');
    }
    ...
    // VANILLA to ...
    event.smithing(Item.of('sophisticatedstorage:basic_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Item.of('minecraft:redstone'));
    event.smithing(Item.of('sophisticatedstorage:basic_to_copper_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/copper'));
    event.smithing(Item.of('sophisticatedstorage:basic_to_iron_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/iron'));
    event.smithing(Item.of('sophisticatedstorage:basic_to_gold_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/gold'));
    event.smithing(Item.of('sophisticatedstorage:basic_to_diamond_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/diamond'));
    event.smithing(Item.of('sophisticatedstorage:basic_to_netherite_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:ingots/netherite'));

    UpgradeIngredient = Item.of('sophisticatedstorage:basic_to_copper_tier_upgrade');
    // COPPER to ...
    event.smithing(Item.of('sophisticatedstorage:copper_to_iron_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/iron'));
    event.smithing(Item.of('sophisticatedstorage:copper_to_gold_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/gold'));
    event.smithing(Item.of('sophisticatedstorage:copper_to_diamond_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/diamond'));
    event.smithing(Item.of('sophisticatedstorage:copper_to_netherite_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:ingots/netherite'));

    UpgradeIngredient = Item.of('sophisticatedstorage:copper_to_iron_tier_upgrade');
    // IRON to ...
    event.smithing(Item.of('sophisticatedstorage:iron_to_gold_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/gold'));
    event.smithing(Item.of('sophisticatedstorage:iron_to_diamond_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/diamond'));
    event.smithing(Item.of('sophisticatedstorage:iron_to_netherite_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:ingots/netherite'));

    UpgradeIngredient = Item.of('sophisticatedstorage:iron_to_gold_tier_upgrade');
    // GOLD to ...
    event.smithing(Item.of('sophisticatedstorage:gold_to_diamond_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:storage_blocks/diamond'));
    event.smithing(Item.of('sophisticatedstorage:gold_to_netherite_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:ingots/netherite'));

    UpgradeIngredient = Item.of('sophisticatedstorage:gold_to_diamond_tier_upgrade');
    // DIAMOND to ...
    event.smithing(Item.of('sophisticatedstorage:diamond_to_netherite_tier_upgrade'), SmithingTemplate, UpgradeIngredient, Ingredient.of('#forge:ingots/netherite'));
