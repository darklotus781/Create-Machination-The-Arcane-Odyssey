...
ServerEvents.recipes(event => {
    ...
    // event.replaceInput({id: 'ae2:network/cells/item_storage_components_cell_1k_part'}, Item.of('ae2:logic_processor'), Item.of('kubejs:cyber_mechanism'));
    // event.replaceInput({id: 'ae2:network/cells/item_storage_components_cell_4k_part'}, Item.of('ae2:calculation_processor'), Item.of('kubejs:cyber_mechanism'));
