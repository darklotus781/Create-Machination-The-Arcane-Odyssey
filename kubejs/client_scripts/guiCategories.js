...
//     // Register a new CustomCategory with the id "machination:mechanisms".
//     event.custom("machination:mechanisms", (category) => {
//         const { jeiHelpers, jeiHelpers: { guiHelper } } = category;
//         // Set the title of the category to "Mechanisms".
...
//                 .icon(guiHelper.createDrawableItemStack(Item.of('kubejs:andesite_mechanism')))
...
//                     global["renderMechanisms"](category.jeiHelpers, recipe, recipeSlotsView, guiGraphics, mouseX, mouseY);
//                 })
//     });
// });
//
...
// global["renderMechanisms"] = (jeiHelpers, recipe, recipeSlotsView, guiGraphics, mouseX, mouseY) => {
...
//     event.custom("machination:mechanisms")
//             .add({name: 'kubejs:andesite_mechanism', type: 'item', description: 'This is the cornerstone of your automations.'})
//             .add({name: 'kubejs:copper_mechanism', type: 'item', description: 'This is the base material for crafting fluid handling items and blocks.'})
//             .add({name: 'kubejs:brass_mechanism', type: 'item', description: 'Anything made of brass probably needs one of these.'})
//     // .add([])
//     // .add("")
//     // .add(true)
//     // .add(50)
