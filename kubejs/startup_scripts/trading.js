...
let FS = (id, x) => MOD("functionalstorage", id, x)
...
StartupEvents.registry('item', event => {
	let profession = (name, c1, c2, transactions) => {
		...
		event.create(`profession_card_${id}`)
			.color(1, c1)
			.color(2, c2)
			.parentModel("kubejs:item/trade_station/profession_card")
			.texture("kubejs:item/trade_station/profession_card_0")
	...
	let trade = (name, c1, c2, transactions, custom) => {
		...
		event.create(`trade_card_${id}`)
			.color(1, c1)
			.color(2, c2)
			.parentModel("kubejs:item/trade_station/trade_card")
			.texture("kubejs:item/trade_station/trade_card_0")
	...
	while (true) {
		...
		simple("Cherry Log", MC('cherry_log', 16), 4, S, 0x24161F, 0xD6A9A1)
		simple("Mangrove Log", MC('mangrove_log', 16), 4, S, 0x403420, 0x5C1C1E)
		...
		simple("Zinc Ingot", AO('zinc_ingot', 8), 16, S, 0x616A60, 0xD0D2C5)
		simple("Copper Ingot", MC('copper_ingot', 8), 16, S, 0xDD7E5D, 0xFCEFBA)
		simple("Nickel Ingot", AO('nickel_ingot', 8), 32, S, 0x977756, 0xE4D196)
		simple("Lead Ingot", AO('lead_ingot', 8), 32, S, 0x232456, 0x7C95A4)
