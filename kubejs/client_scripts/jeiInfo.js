JEIEvents.information((event) => {
    ...
    event.addItem('alexscaves:moth_ball', [
        'Drops from Gloomoths in the Forlorn Hollows.'
    ]);
    event.addItem('alexscaves:amber_curiosity', [
        'Found in Primordial Caves from mining Amber.  It\'s a rare drop with a 1.5% drop chance.',
    ]);
    event.addItem('alexscaves:immortal_embryo', [
        'Drops from the Hullbreaker found in the Abyssal Chasm.',
    ]);
    event.addItem('alexscaves:green_soylent', [
        'Drops from the Brainiac found in the Toxic Caves.',
    ]);
});